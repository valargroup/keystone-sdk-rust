...
impl URType {
    pub fn from(type_str: &str) -> URResult<URType> {
        match type_str {
            ...
            "zcash-sig-result" => Ok(URType::ZcashSigResult(type_str.to_string())),
    ...
    pub fn get_type_str(&self) -> String {
        match self {
            ...
            URType::ZcashSigResult(type_str) => type_str.to_string(),
...
pub const DERIVE_CONTEXT_HASH_CALL: RegistryType =
    RegistryType("derive-context-hash-call", Some(1303));
...
pub const ZCASH_SIG_RESULT: RegistryType = RegistryType("zcash-sig-result", Some(49207));
